...
namespace UnityChan
{
	public class FaceUpdate : MonoBehaviour
	{
		...
		//void OnGUI ()
		//{
		//	GUILayout.Box ("Face Update", GUILayout.Width (500), GUILayout.Height (250 * (animations.Length + 2)));
		//	Rect screenRect = new Rect (10, 25, 600, 500 * (animations.Length + 1));
		//	GUILayout.BeginArea (screenRect);
		//	foreach (var animation in animations) {
		//		if (GUILayout.RepeatButton (animation.name,GUILayout.Height(30), GUILayout.Width(400))) {
